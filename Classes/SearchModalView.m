...
- (void)viewDidLoad 
{
	...
	NSArray *items = [[NSArray alloc] initWithObjects:btnFlexSpace, btnDone, nil];
	self.tb.items = items;
...
- (IBAction)btnDoneClicked: (id)sender {
	...
	DebugLog(@"Search Modal View Done button hit");
